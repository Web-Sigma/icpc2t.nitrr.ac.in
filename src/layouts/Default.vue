    ...
    <div v-cloak>
      <header class="">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark unique-color ">
          <!-- Navbar brand -->
          <router-link class="navbar-brand" to="/new/"
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                ...
                >
                  <router-link class="dropdown-item" to="/new/advisory"
              ...
              <li class="nav-item dropdown">
                ...
                <div
                  ...
                  aria-labelledby="navbarDropdownMenuLink"
                >
                  <router-link class="dropdown-item" to="/new/call-for-papers"
                    >Call for Papers</router-link
                  >

                  <router-link class="dropdown-item" to="/new/tracks"
                    >Tracks / Topics</router-link
                  >
                </div>
              </li>

              <router-link class="nav-link" to="/new/speakers"
                >Keynote Speakers</router-link
              >

              <router-link class="nav-link" to="/new/schedule"
                >Program Schedule</router-link
              >

              <router-link class="nav-link" to="/new/workshops"
              ...
              <router-link class="nav-link" to="/new/partners"
                >Partners</router-link
              >

              <router-link class="nav-link" to="/new/contact"
