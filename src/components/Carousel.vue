            ...
            <div class="full-bg-img flex-center white-text">
              ...
              <ul class="list-unstyled animated fadeIn col-10">
                ...
                <li>
                  ...
                  <a target="_blank" href="https://mdbootstrap.com/education/bootstrap/" class="btn btn-info"
                    rel="nofollow">Read
            ...
            <div class="full-bg-img flex-center white-text">
              ...
              <ul class="list-unstyled animated fadeIn col-md-12">
                ...
                <li>
                  ...
                  <h1 class="h1-responsive font-weight-bold">Sed ut perspiciatis unde omnis iste natus sit voluptatem
                  </h1>
                ...
                <li>
                  ...
                  <a target="_blank" href="https://mdbootstrap.com/forums/forum/support/" class="btn btn-default"
                    rel="nofollow">Read
