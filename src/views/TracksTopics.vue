  ...
  <div>
              ...
              <article>
                <div class="entry-content clearfix">
                  ...
                  <p style="text-align: justify">
                    Students, Faculties, Research Scholars, Scientist, Doctors
                    and Industrial Executives are welcome to submit their
                    research abstract/ full length paper on any of the following
                    themes although not limited to the list:
                  </p>
                  <ul>
        ...
        <div id="secondary">
          <aside id="text-16" class="widget widget_text">
            ...
            <div class="textwidget">
              <p style="text-align: justify">
                <marquee
                  style="color: #f25405; font-family: helvetica"
                  scrollamount="2"
                  scrolldelay="3"
                  direction="up"
                  onmouseover="this.stop()"
                  onmouseout="this.start()"
                  >Deadline for Full Paper Submission extended to 31st
                  October,2019</marquee
                >
              </p>
            </div>
          </aside>
          <aside id="text-11" class="widget widget_text">
            ...
            <div class="textwidget">
              <p>
                Deadline for Full Paper Submission<span style="color: red"
                  >(Final Deadline)</span
                >
              ...
              <p>
                Final Revised Paper Submission : 30<sup>th</sup> November 2019
              </p>
    ...
    <p><strong><a href="../external.html?link=http://innovatiocuris.com/" target="_blank" rel="noopener"><img class="alignnone wp-image-259" src="wp-content/uploads/2018/04/download-300x132.png" alt="" width="157" height="69" /></a></strong></p> -->
          ...
          <aside id="text-12" class="widget widget_text">
            ...
            <div class="textwidget">
              <p>
                Download ICPC<sup>2</sup>T 2020 - Brochure
                <a href="wp-content/uploads/2018/11/ICPC2T.pdf">here</a>
              </p>
            </div>
          </aside>
          ;
