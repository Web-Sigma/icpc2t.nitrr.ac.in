      ...
      <div class="row mt-2 mb-5 pb-3 mx-2">
        ...
        <div class="card card-body mb-5">
          ...
          <p>
            ...
            be given in the comment column in the ‘post author feedback’ in
            author console in CMT. Further, a separate pdf file highlighting the
            changes should be uploaded as the author's feedback file on the same
            page.
          </p>
          ...
          <p>
            ...
            filling out the IEEE copyright form and copyright agreements, there
            is an option to download the completed IEEE Copyright Form in PDF
            (The corresponding author would have received the copyright form
          ...
          <p>
            A full conference registration is mandatory to have the paper
            included in the conference program and the proceedings. The
            registration portal will be opened soon. Please check the website
