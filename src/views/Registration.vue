      ...
      <div id="main" class="clearfix">
        <div class="entry-content clearfix">
          ...
          <ul>
            ...
            <li>
              Conference Bag and Participant Badge (With photograph, paper ID
              and session of presentation)
            </li>
            <li>
          ...
          <p>
            ...
            <a href="mailto:icpc2t@nitrr.ac.in" style="font-weight: bold"
          ...
          <p style="color: #006699; font-size: 18px">
            <strong
              >Banking details for registration (only for Indian
              authors)</strong
            >
          </p>
          <table
          ...
          <strong>
            <p>* Please indicate on transfer: PAPER_ID_ICPC2T</p>
          </strong>
          ...
          <p>
            1) IEEE Members and Student registrants must produce a valid proof
            of Active IEEE Membership Card/ Student ID (with clearly displayed
